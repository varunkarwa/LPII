...
class staff
{
    ...
    int salary;
    void new_staff(String sid,String sname,String desg,String sex,int salary)
    {


        this.sid=sid;
        if(!sid.matches("[A-Za-z0-9]+")){
            throw new IllegalArgumentException("sid is not alphanumeric");
        }
        this.sname=sname;
        this.desg=desg;
        this.sex=sex;
...

{
    ...
    int droom;
    void new_doctor(String did,String dname,String specilist,String appoint,String doc_qual,int droom)
...

                        {
                            case 1:
                            {
                               ...
                               String doc_qual = input.nextLine();
                                ...
                                d[count1].new_doctor(did,dname,specilist,appoint,doc_qual,droom);count1++;
                                break;
                            }
                            case 2:
                            {
...

                        {
                            case 1:
                            {
                               // Scanner input = new Scanner(System.in);
                                ...
                                s[count6].new_staff(sid,sname,desg,sex,salary);count6++;
                                break;
                            }
